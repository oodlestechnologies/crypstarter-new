...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/wasm/v1/contract/{address}/raw/{queryData}
         */
        this.queryRawContractState = (address, queryData, params = {}) => this.request({
            path: `/wasm/v1/contract/${address}/raw/${queryData}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/wasm/v1/contract/{address}/smart/{queryData}
         */
        this.querySmartContractState = (address, queryData, params = {}) => this.request({
            path: `/wasm/v1/contract/${address}/smart/${queryData}`,
            method: "GET",
            format: "json",
            ...params,
        });
